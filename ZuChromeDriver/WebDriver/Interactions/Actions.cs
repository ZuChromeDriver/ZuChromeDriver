...
namespace Zu.WebDriver.Interactions
{
    ...
    public class Actions : IAction
    {
        ...
        public PointerInputDevice defaultMouse = new(PointerKind.Mouse, "default mouse");
        public KeyInputDevice defaultKeyboard = new("default keyboard");
        private IKeyboard keyboard;
        private IMouse mouse;
        private CompositeAction action = new();
