...
namespace Zu.WebDriver.BrowserOptions
{
    ...
    public interface ILocationContext
    {
        ...
        /// </summary>
        Task<Location> GetPhysicalLocation(CancellationToken cancellationToken = default);
   
        /// <summary>
        ///     Sets a value indicating the physical location of the browser.
        /// </summary>
        Task SetPhysicalLocation(Location location, CancellationToken cancellationToken = default);
    }
}