...
namespace Zu.WebDriver.BrowserOptions
{
    ...
    public interface ITimeouts
    {
        ...
        /// </para>
        /// </remarks>
        Task SetImplicitWait(TimeSpan implicitWait, CancellationToken cancellationToken = default);
        Task<TimeSpan> GetImplicitWait(CancellationToken cancellationToken = default);
        ...
        /// method.
        /// </summary>
        Task SetAsynchronousJavaScript(TimeSpan time, CancellationToken cancellationToken = default);
        Task<TimeSpan> GetAsynchronousJavaScript(CancellationToken cancellationToken = default);
        ...
        /// property.
        /// </summary>
        Task SetPageLoad(TimeSpan time, CancellationToken cancellationToken = default);
        Task<TimeSpan> GetPageLoad(CancellationToken cancellationToken = default);
    }
}