...
namespace Zu.WebDriver.BrowserOptions
{
    ...
    public interface ILocalStorage
    {
        ...
        Task<string> GetItem(string key, CancellationToken cancellationToken = default);
        ...
        Task<ReadOnlyCollection<string>> KeySet(CancellationToken cancellationToken = default);
        ...
        Task SetItem(string key, string value, CancellationToken cancellationToken = default);
        ...
        Task<string> RemoveItem(string key, CancellationToken cancellationToken = default);
