...
namespace Zu.WebDriver.AsyncInteractions
{
    ...
    public interface IMouse
    {
        ...
        Task Click(ICoordinates where, CancellationToken cancellationToken = default);

        /// <summary>
        ///     Double-clicks at a set of coordinates.
        /// </summary>
        /// <param name="where">A <see cref="ICoordinates" /> describing where to double-click.</param>
        Task DoubleClick(ICoordinates where, CancellationToken cancellationToken = default);
        ...
        Task MouseDown(ICoordinates where, CancellationToken cancellationToken = default);
        ...
        Task MouseUp(ICoordinates where, CancellationToken cancellationToken = default);
        ...
        Task MouseMove(ICoordinates where, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        /// <param name="where">A <see cref="ICoordinates" /> describing where to click.</param>
        Task ContextClick(ICoordinates where, CancellationToken cancellationToken = default);
        ...
        Task Click(WebPoint location, CancellationToken cancellationToken = default);

        /// <summary>
        ///     Double-clicks at a set of coordinates.
        /// </summary>
        /// <param name="location">A <see cref="WebPoint" /> describing where to double-click.</param>
        Task DoubleClick(WebPoint location, CancellationToken cancellationToken = default);

        /// <summary>
        ///     Presses the primary mouse button at a set of coordinates.
        /// </summary>
        /// <param name="location">A <see cref="WebPoint" /> describing where to press the mouse button down.</param>
        Task MouseDown(WebPoint location, CancellationToken cancellationToken = default);

        /// <summary>
        ///     Releases the primary mouse button at a set of coordinates.
        /// </summary>
        /// <param name="location">A <see cref="WebPoint" /> describing where to release the mouse button.</param>
        Task MouseUp(WebPoint location, CancellationToken cancellationToken = default);

        /// <summary>
        ///     Moves the mouse to the specified set of coordinates.
        /// </summary>
        /// <param name="location">A <see cref="WebPoint" /> describing where to move the mouse to.</param>
        Task MouseMove(WebPoint location, CancellationToken cancellationToken = default);

        /// <summary>
        ///     Clicks at a set of coordinates using the secondary mouse button.
        /// </summary>
        /// <param name="location">A <see cref="WebPoint" /> describing where to click.</param>
        Task ContextClick(WebPoint location, CancellationToken cancellationToken = default);
