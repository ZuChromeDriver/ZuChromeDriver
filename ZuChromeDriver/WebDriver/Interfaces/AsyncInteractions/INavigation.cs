...
namespace Zu.WebDriver.AsyncInteractions
{
    ...
    {
        Task<string> GetUrl(CancellationToken cancellationToken = default);

        /// <summary>
        ///     Move back a single entry in the browser's history.
        /// </summary>
        Task Back(CancellationToken cancellationToken = default);

        /// <summary>
        ///     Move a single "item" forward in the browser's history.
        /// </summary>
        /// <remarks>Does nothing if we are on the latest page viewed.</remarks>
        Task Forward(CancellationToken cancellationToken = default);
        ...
        /// </remarks>
        Task GoToUrl(string url, CancellationToken cancellationToken = default);
        ...
        ///     future calls against this interface will be against the freshly loaded page.
        /// </remarks>
        Task GoToUrl(Uri url, CancellationToken cancellationToken = default);
