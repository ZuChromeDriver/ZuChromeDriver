...
namespace Zu.WebDriver.AsyncInteractions
{
    ...
    public interface IActionExecutor
    {
        ...
        /// </summary>
        Task<bool> IsActionExecutor(CancellationToken cancellationToken = default);
        ...
        Task PerformActions(IList<ActionSequence> actionSequenceList, CancellationToken cancellationToken = default);

        /// <summary>
        /// Resets the input state of the action executor.
        /// </summary>
        Task ResetInputState(CancellationToken cancellationToken = default);
    }
}
