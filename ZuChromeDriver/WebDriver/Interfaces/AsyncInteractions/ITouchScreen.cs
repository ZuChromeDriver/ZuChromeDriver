...
namespace Zu.WebDriver.AsyncInteractions
{
    ...
    public interface ITouchScreen
    {
        ...
        /// </param>
        Task SingleTap(ICoordinates where, CancellationToken cancellationToken = default);
        ...
        Task Down(int locationX, int locationY, CancellationToken cancellationToken = default);
        ...
        /// <param name="locationX">The x coordinate relative to the view port.</param>
        /// <param name="locationY">The y coordinate relative to the view port.</param>
        Task Up(int locationX, int locationY, CancellationToken cancellationToken = default);
        ...
        /// <param name="locationX">The x coordinate relative to the view port.</param>
        /// <param name="locationY">The y coordinate relative to the view port.</param>
        Task Move(int locationX, int locationY, CancellationToken cancellationToken = default);
        ...
        Task Scroll(int offsetX, int offsetY, CancellationToken cancellationToken = default);
        ...
        ///     usually an <see cref="IWebElement" />.
        /// </param>
        Task DoubleTap(ICoordinates where, CancellationToken cancellationToken = default);
        ...
        ///     usually an <see cref="IWebElement" />.
        /// </param>
        Task LongPress(ICoordinates where, CancellationToken cancellationToken = default);
        ...
        Task Flick(int speedX, int speedY, CancellationToken cancellationToken = default);
