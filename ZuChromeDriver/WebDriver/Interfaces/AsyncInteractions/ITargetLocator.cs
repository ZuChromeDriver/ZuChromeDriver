...
namespace Zu.WebDriver.AsyncInteractions
{
    ...
    public interface ITargetLocator
    {
        ...
        Task SwitchToFrame(int frameIndex, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="NoSuchFrameException">If the frame cannot be found.</exception>
        Task SwitchToFrame(string frameName, CancellationToken cancellationToken = default);
        ...
        Task SwitchToFrameByElement(string element, CancellationToken cancellationToken = default);

        /// <summary>
        ///     Select the parent frame of the currently selected frame.
        /// </summary>
        Task SwitchToParentFrame(CancellationToken cancellationToken = default);
        ...
        Task SwitchToWindow(string windowName, CancellationToken cancellationToken = default);

        /// <summary>
        ///     Selects either the first frame on the page or the main document when a page contains iFrames.
        /// </summary>
        Task SwitchToDefaultContent(CancellationToken cancellationToken = default);
        ...
        /// </returns>
        Task<string> SwitchToActiveElement(CancellationToken cancellationToken = default);

        /// <summary>
        ///     Switches to the currently active modal dialog for this particular driver instance.
        /// </summary>
        /// <returns>A handle to the dialog.</returns>
        Task<IAlert> SwitchToAlert(CancellationToken cancellationToken = default);

        Task<string> GetWindowHandle(CancellationToken cancellationToken = default);

        Task<List<string>> GetWindowHandles(CancellationToken cancellationToken = default);
    }
}