...
namespace Zu.WebDriver.AsyncInteractions
{
    ...
    public interface IKeyboard
    {
        ...
        Task SendKeys(string keySequence, CancellationToken cancellationToken = default);
        ...
        Task PressKey(string keyToPress, CancellationToken cancellationToken = default);
        ...
        /// <remarks>The key value must be one of the values from the <see cref="Keys" /> class.</remarks>
        Task ReleaseKey(string keyToRelease, CancellationToken cancellationToken = default);
    }
}