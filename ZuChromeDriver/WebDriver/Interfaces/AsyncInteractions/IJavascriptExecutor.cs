...
namespace Zu.WebDriver.AsyncInteractions
{
    ...
    public interface IJavaScriptExecutor
    {
        ...
        ///     </para>
        /// </remarks>
        Task<object> ExecuteScript(string script, CancellationToken cancellationToken = default,
            params object[] args);
        ...
        /// <param name="args">The arguments to the script.</param>
        /// <returns>The value returned by the script.</returns>
        Task<object> ExecuteAsyncScript(string script, CancellationToken cancellationToken = default,
            params object[] args);
    }
}