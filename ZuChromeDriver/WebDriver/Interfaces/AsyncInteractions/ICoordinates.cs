...
namespace Zu.WebDriver.AsyncInteractions
{
    ...
    public interface ICoordinates
    {
        ...
        /// </summary>
        Task<WebPoint> LocationOnScreen(CancellationToken cancellationToken = default);

        /// <summary>
        ///     Gets the location of an element relative to the origin of the view port.
        /// </summary>
        Task<WebPoint> LocationInViewport(CancellationToken cancellationToken = default);

        /// <summary>
        ///     Gets the location of an element's position within the HTML DOM.
        /// </summary>
        Task<WebPoint> LocationInDom(CancellationToken cancellationToken = default);
