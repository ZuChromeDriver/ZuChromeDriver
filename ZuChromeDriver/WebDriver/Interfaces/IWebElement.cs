...
namespace Zu.WebDriver
{
    ...
    public interface IWebElement : ISearchContext
    {
        ...
        /// <summary>
        ///     Gets the value of a DOM property for this element (distinct from HTML attributes).
        /// </summary>
        Task<string> GetProperty(string propertyName, CancellationToken cancellationToken = new CancellationToken());
