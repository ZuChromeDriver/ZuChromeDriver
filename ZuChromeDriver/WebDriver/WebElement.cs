...
namespace Zu.WebDriver
{
    ...
    public class WebElement : IWebElement, IFindsByLinkText, IFindsById, IFindsByName, IFindsByTagName, IFindsByClassName, IFindsByXPath, IFindsByPartialLinkText, IFindsByCssSelector, IWrapsDriver, ITakesScreenshot, ILocatable, IWebElementReference
    {
        private readonly ZuWebDriver driver;
        /// <summary>
        ...
        public WebElement(ZuWebDriver parentDriver, string id)
        {
            driver = parentDriver;
        ...
        private WebElementCoordinates _elementCoordinates;
        ...
        public Task<IWebElement> FindElementByClassName(string className, string notElementId, TimeSpan timeout, CancellationToken cancellationToken = new CancellationToken())
        {
            ...
            if (driver.IsSpecificationCompliant)
                return FindElement("css selector", "." + EscapeCssSelector(className), notElementId, timeout, cancellationToken);
        ...
        {
            return FindElementByClassName(className, null, default, cancellationToken);
        }
        ...
        {
            return FindElementByClassName(className, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementsByClassName(className, null, default, cancellationToken);
        }
        ...
        {
            return FindElementsByClassName(className, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementByCssSelector(cssSelector, null, default, cancellationToken);
        }
        ...
        {
            return FindElementByCssSelector(cssSelector, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementsByCssSelector(cssSelector, null, default, cancellationToken);
        }
        ...
        {
            return FindElementsByCssSelector(cssSelector, notElementId, default, cancellationToken);
        }
        ...
        public Task<IWebElement> FindElementById(string id, string notElementId, TimeSpan timeout, CancellationToken cancellationToken = new CancellationToken())
        {
            if (string.IsNullOrEmpty(id))
                throw new WebBrowserException("Element not found", "no such element");
        ...
        {
            return FindElementById(id, null, default, cancellationToken);
        }
        ...
        {
            return FindElementById(id, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementsById(id, null, default, cancellationToken);
        }
        ...
        {
            return FindElementsById(id, notElementId, default, cancellationToken);
        }
        ...
        public async Task<ReadOnlyCollection<IWebElement>> FindElementsByIdEndsWithOrDefault(string id, CancellationToken cancellationToken = default)
        {
            try
            {
                var selector = EscapeCssSelector(id);
        ...
        {
            return FindElementByLinkText(linkText, null, default, cancellationToken);
        }
        ...
        {
            return FindElementByLinkText(linkText, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementsByLinkText(linkText, null, default, cancellationToken);
        }
        ...
        {
            return FindElementsByLinkText(linkText, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementByName(name, null, default, cancellationToken);
        }
        ...
        {
            return FindElementByName(name, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementsByName(name, null, default, cancellationToken);
        }
        ...
        {
            return FindElementsByName(name, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementByPartialLinkText(partialLinkText, null, default, cancellationToken);
        }
        ...
        {
            return FindElementByPartialLinkText(partialLinkText, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementsByPartialLinkText(partialLinkText, null, default, cancellationToken);
        }
        ...
        {
            return FindElementsByPartialLinkText(partialLinkText, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementByTagName(tagName, null, default, cancellationToken);
        }
        ...
        {
            return FindElementByTagName(tagName, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementsByTagName(tagName, null, default, cancellationToken);
        }
        ...
        {
            return FindElementsByTagName(tagName, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementByXPath(xpath, null, default, cancellationToken);
        }
        ...
        {
            return FindElementByXPath(xpath, notElementId, default, cancellationToken);
        }
        ...
        {
            return FindElementsByXPath(xpath, null, default, cancellationToken);
        }
        ...
        {
            return FindElementsByXPath(xpath, notElementId, default, cancellationToken);
        }
        ...
        public async Task<ReadOnlyCollection<IWebElement>> FindElementsByIdStartsWithOrDefault(string id, CancellationToken cancellationToken = default)
        {
            try
            {
                var selector = EscapeCssSelector(id);
        ...
        public async Task<IWebElement> FindElementOrDefault(By @by, CancellationToken cancellationToken = default)
        {
            try
            {
        ...
        {
            return FindElement(mechanism, value, null, default, cancellationToken);
        }
        ...
        public async Task<ReadOnlyCollection<IWebElement>> FindElementsOrDefault(By @by, CancellationToken cancellationToken = default)
        {
            try
            {
        ...
        {
            return FindElements(mechanism, value, null, default, cancellationToken);
        }
        ...
        /// </summary>
        public async Task<WebPoint> LocationOnScreenOnceScrolledIntoView(CancellationToken cancellationToken = new CancellationToken())
        {
            if (driver.browserClient is IChromeDriver chromeDriver && chromeDriver.ElementUtils != null)
                return await chromeDriver.ElementUtils.GetLocationOnScreenOnceScrolledIntoView(InternalElementId, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <inheritdoc />
        /// <remarks>Per-element coordinates (Selenium parity); not the driver's shared coordinate stub.</remarks>
        public ICoordinates Coordinates =>
            _elementCoordinates ??= new WebElementCoordinates(this);
        ...
        Dictionary<string, object> IWebElementReference.ToDictionary()
        {
            ...
            {
                { "element-6066-11e4-a52e-4f735466cecf", this.InternalElementId }
            };
        ...
        public async Task SendKeys(string text, CancellationToken cancellationToken = new CancellationToken())
        {
            ...
            try
            {
                var implicitWait = await driver.Options().Timeouts.GetImplicitWait(cancellationToken).ConfigureAwait(false);
                var timeoutMs = SimpleCommandsTimeoutMs;
                if (implicitWait > TimeSpan.Zero)
                {
                    var extra = (int)Math.Min(implicitWait.TotalMilliseconds, int.MaxValue - timeoutMs);
                    timeoutMs += extra;
                }

                await driver.browserClient.Elements.SendKeysToElement(InternalElementId, text, cancellationToken).TimeoutAfter(timeoutMs).ConfigureAwait(false);
            }
            catch
            {
                throw;
        ...
        public async Task Click(CancellationToken cancellationToken = new CancellationToken())
        {
            if (driver.browserClient == null)
                throw new WebDriverException("no browserClient");
            var tag = await TagName(cancellationToken).ConfigureAwait(false);
            if (string.Equals(tag, "input", StringComparison.OrdinalIgnoreCase))
            {
                var typeAttr = await GetAttribute("type", cancellationToken).ConfigureAwait(false);
                if (string.Equals(typeAttr, "file", StringComparison.OrdinalIgnoreCase))
                    throw new WebDriverException("invalid element state");
            }
        ...
        public override bool Equals(object obj)
        {
            if (obj == null)
                return false;
            return InternalElementId == (obj as WebElement).InternalElementId;
        }
        ...
        public Dictionary<string, object> ToElementReference()
        {
            ...
            {
                ["element-6066-11e4-a52e-4f735466cecf"] = InternalElementId
            };
            return elementDictionary;
        }
    }
