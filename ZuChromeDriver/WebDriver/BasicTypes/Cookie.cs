...
namespace Zu.WebDriver.BasicTypes
{
    ...
    public class Cookie
    {
        ...
        private readonly bool? _optionalSecure = null;
        private readonly bool? _optionalHttpOnly = null;
        private readonly string _sameSite = null;
        ...
        /// <summary>
        ///     Full cookie shape matching Selenium 4 (secure, http-only, SameSite).
        /// </summary>
        public Cookie(string name, string value, string domain, string path, DateTime? expiry, bool secure, bool httpOnly, string sameSite)
            : this(name, value, domain, path, expiry)
        {
            _optionalSecure = secure;
            _optionalHttpOnly = httpOnly;
            _sameSite = ValidateSameSite(sameSite);
        }
        ...
        public virtual bool Secure => _optionalSecure ?? false;

        /// <summary>
        ///     Gets a value indicating whether the cookie is an HTTP-only cookie.
        /// </summary>
        [JsonPropertyName("httpOnly")]
        public virtual bool IsHttpOnly => _optionalHttpOnly ?? false;

        /// <summary>
        ///     SameSite attribute when set (Strict, Lax, or None).
        /// </summary>
        [JsonPropertyName("sameSite")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public virtual string SameSite => _sameSite;
        ...
        private static string ValidateSameSite(string sameSite)
        {
            ...
            throw new ArgumentException("Invalid SameSite: " + sameSite, nameof(sameSite));
        }
    }
}