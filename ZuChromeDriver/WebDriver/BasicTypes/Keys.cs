...
namespace Zu.WebDriver.BasicTypes
{
    ...
    public static class Keys
    {
        ...
        //System.Windows.Clipboard.SetText(string.Join(Environment.NewLine, typeof(Zu.WebDriver.Keys).GetFields().Select(v => $"\t\t\t{{ (char)0x{((int)(((string)v.GetValue(null))[0])).ToString("X")}, 0x00 }}, // {v.Name} ")))
        //https://msdn.microsoft.com/en-us/En-en/library/windows/desktop/dd375731(v=vs.85).aspx
        public static Dictionary<char, int> KeyToVirtualKeyCode = new()
        {
        ...
        public static object GetDescription(string value)
        {
