...
namespace Zu.ZuChromeDriver.Tests
{
    ...
    public class ClickTest : DriverTestFixture
    {
        ...
        {
            await driver.FindElement(By.Id("normal")).Click();
        ...
        [Test]
        [Ignore("ZuChromeDriver: SwitchToFrame fails for oversized iframe page (WebBrowserException); equivalent upstream ClickTests.ShouldBeAbleToClickOnAnElementInFrameGreaterThanTwoViewports.")]
        public async Task ShouldBeAbleToClickOnAnElementInFrameGreaterThanTwoViewports()
        {
            await driver.GoToUrl(EnvironmentManager.Instance.UrlBuilder.WhereIs("click_too_big_in_frame.html"));
