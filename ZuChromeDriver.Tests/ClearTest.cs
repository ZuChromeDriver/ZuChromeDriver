...
namespace Zu.ZuChromeDriver.Tests
{
    ...
    public class ClearTest : DriverTestFixture
    {
        ...
        {
            await ShouldBeAbleToClearInput(By.Name("url_input"), "https://selenium.dev/");
        }

        [Test]
        public async Task ShouldBeAbleToClearRangeInput()
        {
            await ShouldBeAbleToClearInput(By.Name("range_input"), "42", "50");
        }

        [Test]
        public async Task ShouldBeAbleToClearColorInput()
        {
            await ShouldBeAbleToClearInput(By.Name("color_input"), "#00ffff", "#000000");
        }

        [Test]
        public async Task ShouldBeAbleToClearDateInput()
        {
            await ShouldBeAbleToClearInput(By.Name("date_input"), "2017-11-22");
        }
        ...
        [Test]
        public async Task ShouldBeAbleToClearDatetimeLocalInput()
        {
            await ShouldBeAbleToClearInput(By.Name("datetime_local_input"), "2017-11-22T11:22");
        }

        [Test]
        public async Task ShouldBeAbleToClearTimeInput()
        {
            await ShouldBeAbleToClearInput(By.Name("time_input"), "11:22");
        }

        [Test]
        public async Task ShouldBeAbleToClearMonthInput()
        {
            await ShouldBeAbleToClearInput(By.Name("month_input"), "2017-11");
        }

        [Test]
        public async Task ShouldBeAbleToClearWeekInput()
        {
            await ShouldBeAbleToClearInput(By.Name("week_input"), "2017-W47");
        }
