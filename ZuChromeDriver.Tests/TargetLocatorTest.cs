...
namespace Zu.ZuChromeDriver.Tests
{
    ...
    public class TargetLocatorTest : DriverTestFixture
    {
        ...
        public async Task ShouldThrowExceptionAfterSwitchingToNonExistingFrameIndex()
        {
            ...
            await AssertEx.ThrowsAsync<NoSuchFrameException>(async () => await driver.SwitchTo().Frame(10));
        }
        ...
        {
            await driver.GoToUrl(framesPage);
            await AssertEx.ThrowsAsync<NoSuchFrameException>(
                async () => await driver.SwitchTo().Frame("æ©ñµøöíúüþ®éåä²doesnotexist"));
        }
