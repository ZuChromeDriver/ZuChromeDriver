...
namespace Zu.ZuChromeDriver.Tests
{
    ...
    public class FrameSwitchingTest : DriverTestFixture
    {
        ...
        public async Task ShouldEnsureElementIsAFrameBeforeSwitching()
        {
            ...
            await AssertEx.ThrowsAsync<NoSuchFrameException>(async () => await driver.SwitchTo().Frame(frame));
        }
        ...
        public async Task ShouldThrowFrameNotFoundExceptionLookingUpSubFramesWithSuperFrameNames()
        {
            ...
            await AssertEx.ThrowsAsync<NoSuchFrameException>(async () => await driver.SwitchTo().Frame("second"));
        ...
        public async Task ShouldThrowAnExceptionWhenAFrameCannotBeFound()
        {
            ...
            await AssertEx.ThrowsAsync<NoSuchFrameException>(async () => await driver.SwitchTo().Frame("Nothing here"));
        }
        ...
        public async Task ShouldThrowAnExceptionWhenAFrameCannotBeFoundByIndex()
        {
            ...
            await AssertEx.ThrowsAsync<NoSuchFrameException>(async () => await driver.SwitchTo().Frame(27));
        }
        ...
        public async Task ShouldContinueToReferToTheSameFrameOnceItHasBeenSelected()
        {
            ...
            {
                try {
                    var p = await driver.FindElement(By.XPath("//p"));
                    return string.Equals(await p.Text(), "Success!", StringComparison.Ordinal);
                }
                catch (Exception) {
                    return false;
                }
            }, "Expected Success! paragraph in frame after submit");
        }
        ...
        public async Task ShouldFocusOnTheReplacementWhenAFrameFollowsALinkToA_TopTargettedPage()
        {
            ...
            await WaitFor(async () => string.Equals(await driver.Title(), "XHTML Test Page", System.StringComparison.Ordinal), "Title did not become XHTML Test Page after navigating via target=_top");
            Assert.AreEqual("XHTML Test Page", await driver.Title());
        }
        ...
        /// <summary>
        /// Upstream <c>FrameSwitchingTests.ShouldNotBeAbleToDoAnythingTheFrameIsDeletedFromUnderUs</c> expects
        /// <see cref="NoSuchWindowException"/>; Chrome drivers typically throw <see cref="NoSuchElementException"/> instead
        /// (<see href="https://github.com/SeleniumHQ/selenium/blob/trunk/dotnet/test/webdriver/FrameSwitchingTests.cs"/> IgnoreBrowser Chrome).
        /// </summary>
        [Test]
        [Ignore("Chrome/CDP: same as upstream IgnoreBrowser(Chrome) — FindElement after iframe removal does not throw NoSuchWindowException.")]
        public async Task ShouldNotBeAbleToDoAnythingTheFrameIsDeletedFromUnderUs()
        {
            await driver.GoToUrl(deletingFrame);
            await driver.SwitchTo().Frame("iframe1");
            ...
            await AssertEx.ThrowsAsync<NoSuchWindowException>(async () => await driver.FindElement(By.Id("killIframe")));
        }
        ...
        private async Task<string> GetTextOfGreetingElement()
        {
            ...
            while (DateTime.Now < end) {
                ...
                } catch (WebBrowserException ex) when (string.Equals(ex.Error, "no such element", StringComparison.OrdinalIgnoreCase)) {
                }
            }
