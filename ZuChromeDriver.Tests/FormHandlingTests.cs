...
namespace Zu.ZuChromeDriver.Tests
{
    ...
    public class FormHandlingTests : DriverTestFixture
    {
        ...
        [Test]
        public async Task ShouldNotBeAbleToSubmitAnInputOutsideAForm()
        {
            await driver.GoToUrl(formsPage);
        ...
        [Test]
        public async Task ShouldSubmitAFormWithIdSubmit()
        {
            await driver.GoToUrl(formsPage);
        ...
        [Test]
        public async Task ShouldSubmitAFormWithNameSubmit()
        {
            await driver.GoToUrl(formsPage);
        ...
        public async Task ShouldBeAbleToAlterTheContentsOfAFileUploadInputElement()
        {
            ...
            System.IO.FileInfo outputFile = new(await uploadElement.GetAttribute("value"));
        ...
        public async Task ShouldBeAbleToSendKeysToAFileUploadInputElementInAnXhtmlDocument()
        {
            ...
            Assert.AreEqual(string.Empty, await uploadElement.GetAttribute("value"));
        ...
        public async Task ShouldBeAbleToUploadTheSameFileTwice()
        {
            ...
            for (int i = 0; i < 2; ++i) {
                ...
                await WaitFor(async () => (await driver.GetUrl()).EndsWith("resultPage.html"), "We are not redirected to the resultPage after submitting web element");
            }
        ...
        public async Task SendingKeyboardEventsShouldAppendTextInInputsWithExistingValue()
        {
            ...
            await element.SendKeys(Keys.End);
            await element.SendKeys(". Some text");
            string value = await element.GetAttribute("value");
        ...
        public async Task SendingKeyboardEventsShouldAppendTextInTextAreas()
        {
            ...
            await driver.ExecuteScript(
                "var e = arguments[0]; e.focus(); var n = e.value.length; e.setSelectionRange(n, n);",
                default,
                element);
            await element.SendKeys(". Some text");
            String value = await element.GetAttribute("value");
        ...
        public async Task EmptyTextBoxesShouldReturnAnEmptyStringNotNull()
        {
            ...
            Assert.AreEqual(await emptyTextArea.GetAttribute("value"), "");
        }
