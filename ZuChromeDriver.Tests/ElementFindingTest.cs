...
namespace Zu.ZuChromeDriver.Tests
{
    ...
    public class ElementFindingTest : DriverTestFixture
    {
        ...
        public async Task ShouldNotBeAbleToLocateByIdASingleElementThatDoesNotExist()
        {
            ...
            await AssertEx.ThrowsAsync<WebBrowserException>(async () => await driver.FindElement(By.Id("nonExistentButton")),
                exception => Assert.That(exception.Error, Is.EqualTo("no such element")));
        }
