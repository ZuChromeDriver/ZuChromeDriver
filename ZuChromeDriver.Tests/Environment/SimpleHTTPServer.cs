...
public class SimpleHTTPServer
{
    ...
    public void Stop()
    {
        ...
        {
            // Stop may throw if the listener is already closed or stopped.
        }

        if (_serverThread != null && _serverThread.IsAlive)
            _serverThread.Join(TimeSpan.FromSeconds(30));
    }
    ...
    private void Listen()
    {
        try
        {
            ...
            while (true)
            {
                ...
                {
                    // Preserve prior behavior: isolated request failures should not stop the server.
                }
            }
        }
        finally
