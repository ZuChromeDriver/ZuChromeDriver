...
namespace Zu.ZuChromeDriver.Tests
{
    ...
    public class JavascriptEnabledBrowserTest : DriverTestFixture
    {
        ...
        public async Task Issue80ClickShouldGenerateClickEvent()
        {
            ...
            Assert.AreEqual("Hello", await element.GetAttribute("value"));

            await element.Click();

            Assert.AreEqual("Clicked", await element.GetAttribute("value"));
        }
        ...
        public async Task ShouldBeAbleToSwitchToFocusedElement()
        {
            ...
            Assert.AreEqual("theworks", await element.GetAttribute("id"));
        }
        ...
        public async Task IfNoElementHasFocusTheActiveElementIsTheBody()
        {
            ...
            Assert.AreEqual("body", await element.GetAttribute("name"));
        }
