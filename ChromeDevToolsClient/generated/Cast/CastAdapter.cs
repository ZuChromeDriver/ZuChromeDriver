namespace Zu.ChromeDevTools.Cast
{
    ...
    /// </summary>
    public partial class CastAdapter
    {
        ...
        /// </summary>
        public async Task<SetSinkToUseCommandResponse> SetSinkToUse(SetSinkToUseCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<StartDesktopMirroringCommandResponse> StartDesktopMirroring(StartDesktopMirroringCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<StartTabMirroringCommandResponse> StartTabMirroring(StartTabMirroringCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<StopCastingCommandResponse> StopCasting(StopCastingCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
