namespace Zu.ChromeDevTools.HeadlessExperimental
{
    ...
    /// </summary>
    public partial class HeadlessExperimentalAdapter
    {
        ...
        /// </summary>
        public async Task<BeginFrameCommandResponse> BeginFrame(BeginFrameCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
