namespace Zu.ChromeDevTools.WebAudio
{
    ...
    /// </summary>
    public partial class WebAudioAdapter
    {
        ...
        /// </summary>
        public async Task<GetRealtimeDataCommandResponse> GetRealtimeData(GetRealtimeDataCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
