    ...
    public static class EventTypeMap
    {
        ...
        static EventTypeMap()
        {
            s_methodNameEventTypeDictionary = new Dictionary<string, Type>()
            {
                ...
                { "Animation.animationUpdated", typeof(Animation.AnimationUpdatedEvent) },
                { "Audits.issueAdded", typeof(Audits.IssueAddedEvent) },
                { "Autofill.addressFormFilled", typeof(Autofill.AddressFormFilledEvent) },
                ...
                { "BluetoothEmulation.gattOperationReceived", typeof(BluetoothEmulation.GattOperationReceivedEvent) },
                { "BluetoothEmulation.characteristicOperationReceived", typeof(BluetoothEmulation.CharacteristicOperationReceivedEvent) },
                { "BluetoothEmulation.descriptorOperationReceived", typeof(BluetoothEmulation.DescriptorOperationReceivedEvent) },
                ...
                { "CSS.computedStyleUpdated", typeof(CSS.ComputedStyleUpdatedEvent) },
                ...
                { "DOM.adoptedStyleSheetsModified", typeof(DOM.AdoptedStyleSheetsModifiedEvent) },
                ...
                { "DOM.topLayerElementsUpdated", typeof(DOM.TopLayerElementsUpdatedEvent) },
                { "DOM.scrollableFlagUpdated", typeof(DOM.ScrollableFlagUpdatedEvent) },
                { "DOM.adRelatedStateUpdated", typeof(DOM.AdRelatedStateUpdatedEvent) },
                { "DOM.affectedByStartingStylesFlagUpdated", typeof(DOM.AffectedByStartingStylesFlagUpdatedEvent) },
                ...
                { "DeviceAccess.deviceRequestPrompted", typeof(DeviceAccess.DeviceRequestPromptedEvent) },
                { "Emulation.virtualTimeBudgetExpired", typeof(Emulation.VirtualTimeBudgetExpiredEvent) },
                { "Emulation.screenOrientationLockChanged", typeof(Emulation.ScreenOrientationLockChangedEvent) },
                { "FedCm.dialogShown", typeof(FedCm.DialogShownEvent) },
                { "FedCm.dialogClosed", typeof(FedCm.DialogClosedEvent) },
                ...
                { "Inspector.workerScriptLoaded", typeof(Inspector.WorkerScriptLoadedEvent) },
                ...
                { "Media.playerCreated", typeof(Media.PlayerCreatedEvent) },
                ...
                { "Network.directTCPSocketCreated", typeof(Network.DirectTCPSocketCreatedEvent) },
                { "Network.directTCPSocketOpened", typeof(Network.DirectTCPSocketOpenedEvent) },
                { "Network.directTCPSocketAborted", typeof(Network.DirectTCPSocketAbortedEvent) },
                { "Network.directTCPSocketClosed", typeof(Network.DirectTCPSocketClosedEvent) },
                { "Network.directTCPSocketChunkSent", typeof(Network.DirectTCPSocketChunkSentEvent) },
                { "Network.directTCPSocketChunkReceived", typeof(Network.DirectTCPSocketChunkReceivedEvent) },
                { "Network.directUDPSocketJoinedMulticastGroup", typeof(Network.DirectUDPSocketJoinedMulticastGroupEvent) },
                { "Network.directUDPSocketLeftMulticastGroup", typeof(Network.DirectUDPSocketLeftMulticastGroupEvent) },
                { "Network.directUDPSocketCreated", typeof(Network.DirectUDPSocketCreatedEvent) },
                { "Network.directUDPSocketOpened", typeof(Network.DirectUDPSocketOpenedEvent) },
                { "Network.directUDPSocketAborted", typeof(Network.DirectUDPSocketAbortedEvent) },
                { "Network.directUDPSocketClosed", typeof(Network.DirectUDPSocketClosedEvent) },
                { "Network.directUDPSocketChunkSent", typeof(Network.DirectUDPSocketChunkSentEvent) },
                { "Network.directUDPSocketChunkReceived", typeof(Network.DirectUDPSocketChunkReceivedEvent) },
                ...
                { "Network.responseReceivedEarlyHints", typeof(Network.ResponseReceivedEarlyHintsEvent) },
                { "Network.trustTokenOperationDone", typeof(Network.TrustTokenOperationDoneEvent) },
                { "Network.policyUpdated", typeof(Network.PolicyUpdatedEvent) },
                ...
                { "Network.deviceBoundSessionsAdded", typeof(Network.DeviceBoundSessionsAddedEvent) },
                { "Network.deviceBoundSessionEventOccurred", typeof(Network.DeviceBoundSessionEventOccurredEvent) },
                ...
                { "Overlay.inspectPanelShowRequested", typeof(Overlay.InspectPanelShowRequestedEvent) },
                { "Overlay.inspectedElementWindowRestored", typeof(Overlay.InspectedElementWindowRestoredEvent) },
                ...
                { "Page.frameSubtreeWillBeDetached", typeof(Page.FrameSubtreeWillBeDetachedEvent) },
                ...
                { "Page.frameStartedNavigating", typeof(Page.FrameStartedNavigatingEvent) },
                ...
                { "Preload.ruleSetUpdated", typeof(Preload.RuleSetUpdatedEvent) },
                { "Preload.ruleSetRemoved", typeof(Preload.RuleSetRemovedEvent) },
                { "Preload.preloadEnabledStateUpdated", typeof(Preload.PreloadEnabledStateUpdatedEvent) },
                { "Preload.prefetchStatusUpdated", typeof(Preload.PrefetchStatusUpdatedEvent) },
                { "Preload.prerenderStatusUpdated", typeof(Preload.PrerenderStatusUpdatedEvent) },
                { "Preload.preloadingAttemptSourcesUpdated", typeof(Preload.PreloadingAttemptSourcesUpdatedEvent) },
                ...
                { "SmartCardEmulation.establishContextRequested", typeof(SmartCardEmulation.EstablishContextRequestedEvent) },
                { "SmartCardEmulation.releaseContextRequested", typeof(SmartCardEmulation.ReleaseContextRequestedEvent) },
                { "SmartCardEmulation.listReadersRequested", typeof(SmartCardEmulation.ListReadersRequestedEvent) },
                { "SmartCardEmulation.getStatusChangeRequested", typeof(SmartCardEmulation.GetStatusChangeRequestedEvent) },
                { "SmartCardEmulation.cancelRequested", typeof(SmartCardEmulation.CancelRequestedEvent) },
                { "SmartCardEmulation.connectRequested", typeof(SmartCardEmulation.ConnectRequestedEvent) },
                { "SmartCardEmulation.disconnectRequested", typeof(SmartCardEmulation.DisconnectRequestedEvent) },
                { "SmartCardEmulation.transmitRequested", typeof(SmartCardEmulation.TransmitRequestedEvent) },
                { "SmartCardEmulation.controlRequested", typeof(SmartCardEmulation.ControlRequestedEvent) },
                { "SmartCardEmulation.getAttribRequested", typeof(SmartCardEmulation.GetAttribRequestedEvent) },
                { "SmartCardEmulation.setAttribRequested", typeof(SmartCardEmulation.SetAttribRequestedEvent) },
                { "SmartCardEmulation.statusRequested", typeof(SmartCardEmulation.StatusRequestedEvent) },
                { "SmartCardEmulation.beginTransactionRequested", typeof(SmartCardEmulation.BeginTransactionRequestedEvent) },
                { "SmartCardEmulation.endTransactionRequested", typeof(SmartCardEmulation.EndTransactionRequestedEvent) },
                ...
                { "Storage.interestGroupAuctionEventOccurred", typeof(Storage.InterestGroupAuctionEventOccurredEvent) },
                { "Storage.interestGroupAuctionNetworkRequestCreated", typeof(Storage.InterestGroupAuctionNetworkRequestCreatedEvent) },
                { "Storage.sharedStorageAccessed", typeof(Storage.SharedStorageAccessedEvent) },
                { "Storage.sharedStorageWorkletOperationExecutionFinished", typeof(Storage.SharedStorageWorkletOperationExecutionFinishedEvent) },
                { "Storage.storageBucketCreatedOrUpdated", typeof(Storage.StorageBucketCreatedOrUpdatedEvent) },
                { "Storage.storageBucketDeleted", typeof(Storage.StorageBucketDeletedEvent) },
                ...
                { "WebAuthn.credentialAdded", typeof(WebAuthn.CredentialAddedEvent) },
                { "WebAuthn.credentialDeleted", typeof(WebAuthn.CredentialDeletedEvent) },
                { "WebAuthn.credentialUpdated", typeof(WebAuthn.CredentialUpdatedEvent) },
                { "WebAuthn.credentialAsserted", typeof(WebAuthn.CredentialAssertedEvent) },
                { "WebMCP.toolsAdded", typeof(WebMCP.ToolsAddedEvent) },
                { "WebMCP.toolsRemoved", typeof(WebMCP.ToolsRemovedEvent) },
                { "WebMCP.toolInvoked", typeof(WebMCP.ToolInvokedEvent) },
                { "WebMCP.toolResponded", typeof(WebMCP.ToolRespondedEvent) },
            ...
            s_eventTypeMethodNameDictionary = new Dictionary<Type, string>()
            {
                ...
                { typeof(Animation.AnimationUpdatedEvent), "Animation.animationUpdated" },
                { typeof(Audits.IssueAddedEvent), "Audits.issueAdded" },
                { typeof(Autofill.AddressFormFilledEvent), "Autofill.addressFormFilled" },
                ...
                { typeof(BluetoothEmulation.GattOperationReceivedEvent), "BluetoothEmulation.gattOperationReceived" },
                { typeof(BluetoothEmulation.CharacteristicOperationReceivedEvent), "BluetoothEmulation.characteristicOperationReceived" },
                { typeof(BluetoothEmulation.DescriptorOperationReceivedEvent), "BluetoothEmulation.descriptorOperationReceived" },
                ...
                { typeof(CSS.ComputedStyleUpdatedEvent), "CSS.computedStyleUpdated" },
                ...
                { typeof(DOM.AdoptedStyleSheetsModifiedEvent), "DOM.adoptedStyleSheetsModified" },
                ...
                { typeof(DOM.TopLayerElementsUpdatedEvent), "DOM.topLayerElementsUpdated" },
                { typeof(DOM.ScrollableFlagUpdatedEvent), "DOM.scrollableFlagUpdated" },
                { typeof(DOM.AdRelatedStateUpdatedEvent), "DOM.adRelatedStateUpdated" },
                { typeof(DOM.AffectedByStartingStylesFlagUpdatedEvent), "DOM.affectedByStartingStylesFlagUpdated" },
                ...
                { typeof(DeviceAccess.DeviceRequestPromptedEvent), "DeviceAccess.deviceRequestPrompted" },
                { typeof(Emulation.VirtualTimeBudgetExpiredEvent), "Emulation.virtualTimeBudgetExpired" },
                { typeof(Emulation.ScreenOrientationLockChangedEvent), "Emulation.screenOrientationLockChanged" },
                { typeof(FedCm.DialogShownEvent), "FedCm.dialogShown" },
                { typeof(FedCm.DialogClosedEvent), "FedCm.dialogClosed" },
                ...
                { typeof(Inspector.WorkerScriptLoadedEvent), "Inspector.workerScriptLoaded" },
                ...
                { typeof(Media.PlayerCreatedEvent), "Media.playerCreated" },
                ...
                { typeof(Network.DirectTCPSocketCreatedEvent), "Network.directTCPSocketCreated" },
                { typeof(Network.DirectTCPSocketOpenedEvent), "Network.directTCPSocketOpened" },
                { typeof(Network.DirectTCPSocketAbortedEvent), "Network.directTCPSocketAborted" },
                { typeof(Network.DirectTCPSocketClosedEvent), "Network.directTCPSocketClosed" },
                { typeof(Network.DirectTCPSocketChunkSentEvent), "Network.directTCPSocketChunkSent" },
                { typeof(Network.DirectTCPSocketChunkReceivedEvent), "Network.directTCPSocketChunkReceived" },
                { typeof(Network.DirectUDPSocketJoinedMulticastGroupEvent), "Network.directUDPSocketJoinedMulticastGroup" },
                { typeof(Network.DirectUDPSocketLeftMulticastGroupEvent), "Network.directUDPSocketLeftMulticastGroup" },
                { typeof(Network.DirectUDPSocketCreatedEvent), "Network.directUDPSocketCreated" },
                { typeof(Network.DirectUDPSocketOpenedEvent), "Network.directUDPSocketOpened" },
                { typeof(Network.DirectUDPSocketAbortedEvent), "Network.directUDPSocketAborted" },
                { typeof(Network.DirectUDPSocketClosedEvent), "Network.directUDPSocketClosed" },
                { typeof(Network.DirectUDPSocketChunkSentEvent), "Network.directUDPSocketChunkSent" },
                { typeof(Network.DirectUDPSocketChunkReceivedEvent), "Network.directUDPSocketChunkReceived" },
                ...
                { typeof(Network.ResponseReceivedEarlyHintsEvent), "Network.responseReceivedEarlyHints" },
                { typeof(Network.TrustTokenOperationDoneEvent), "Network.trustTokenOperationDone" },
                { typeof(Network.PolicyUpdatedEvent), "Network.policyUpdated" },
                ...
                { typeof(Network.DeviceBoundSessionsAddedEvent), "Network.deviceBoundSessionsAdded" },
                { typeof(Network.DeviceBoundSessionEventOccurredEvent), "Network.deviceBoundSessionEventOccurred" },
                ...
                { typeof(Overlay.InspectPanelShowRequestedEvent), "Overlay.inspectPanelShowRequested" },
                { typeof(Overlay.InspectedElementWindowRestoredEvent), "Overlay.inspectedElementWindowRestored" },
                ...
                { typeof(Page.FrameSubtreeWillBeDetachedEvent), "Page.frameSubtreeWillBeDetached" },
                ...
                { typeof(Page.FrameStartedNavigatingEvent), "Page.frameStartedNavigating" },
                ...
                { typeof(Preload.RuleSetUpdatedEvent), "Preload.ruleSetUpdated" },
                { typeof(Preload.RuleSetRemovedEvent), "Preload.ruleSetRemoved" },
                { typeof(Preload.PreloadEnabledStateUpdatedEvent), "Preload.preloadEnabledStateUpdated" },
                { typeof(Preload.PrefetchStatusUpdatedEvent), "Preload.prefetchStatusUpdated" },
                { typeof(Preload.PrerenderStatusUpdatedEvent), "Preload.prerenderStatusUpdated" },
                { typeof(Preload.PreloadingAttemptSourcesUpdatedEvent), "Preload.preloadingAttemptSourcesUpdated" },
                ...
                { typeof(SmartCardEmulation.EstablishContextRequestedEvent), "SmartCardEmulation.establishContextRequested" },
                { typeof(SmartCardEmulation.ReleaseContextRequestedEvent), "SmartCardEmulation.releaseContextRequested" },
                { typeof(SmartCardEmulation.ListReadersRequestedEvent), "SmartCardEmulation.listReadersRequested" },
                { typeof(SmartCardEmulation.GetStatusChangeRequestedEvent), "SmartCardEmulation.getStatusChangeRequested" },
                { typeof(SmartCardEmulation.CancelRequestedEvent), "SmartCardEmulation.cancelRequested" },
                { typeof(SmartCardEmulation.ConnectRequestedEvent), "SmartCardEmulation.connectRequested" },
                { typeof(SmartCardEmulation.DisconnectRequestedEvent), "SmartCardEmulation.disconnectRequested" },
                { typeof(SmartCardEmulation.TransmitRequestedEvent), "SmartCardEmulation.transmitRequested" },
                { typeof(SmartCardEmulation.ControlRequestedEvent), "SmartCardEmulation.controlRequested" },
                { typeof(SmartCardEmulation.GetAttribRequestedEvent), "SmartCardEmulation.getAttribRequested" },
                { typeof(SmartCardEmulation.SetAttribRequestedEvent), "SmartCardEmulation.setAttribRequested" },
                { typeof(SmartCardEmulation.StatusRequestedEvent), "SmartCardEmulation.statusRequested" },
                { typeof(SmartCardEmulation.BeginTransactionRequestedEvent), "SmartCardEmulation.beginTransactionRequested" },
                { typeof(SmartCardEmulation.EndTransactionRequestedEvent), "SmartCardEmulation.endTransactionRequested" },
                ...
                { typeof(Storage.InterestGroupAuctionEventOccurredEvent), "Storage.interestGroupAuctionEventOccurred" },
                { typeof(Storage.InterestGroupAuctionNetworkRequestCreatedEvent), "Storage.interestGroupAuctionNetworkRequestCreated" },
                { typeof(Storage.SharedStorageAccessedEvent), "Storage.sharedStorageAccessed" },
                { typeof(Storage.SharedStorageWorkletOperationExecutionFinishedEvent), "Storage.sharedStorageWorkletOperationExecutionFinished" },
                { typeof(Storage.StorageBucketCreatedOrUpdatedEvent), "Storage.storageBucketCreatedOrUpdated" },
                { typeof(Storage.StorageBucketDeletedEvent), "Storage.storageBucketDeleted" },
                ...
                { typeof(WebAuthn.CredentialAddedEvent), "WebAuthn.credentialAdded" },
                { typeof(WebAuthn.CredentialDeletedEvent), "WebAuthn.credentialDeleted" },
                { typeof(WebAuthn.CredentialUpdatedEvent), "WebAuthn.credentialUpdated" },
                { typeof(WebAuthn.CredentialAssertedEvent), "WebAuthn.credentialAsserted" },
                { typeof(WebMCP.ToolsAddedEvent), "WebMCP.toolsAdded" },
                { typeof(WebMCP.ToolsRemovedEvent), "WebMCP.toolsRemoved" },
                { typeof(WebMCP.ToolInvokedEvent), "WebMCP.toolInvoked" },
                { typeof(WebMCP.ToolRespondedEvent), "WebMCP.toolResponded" },
