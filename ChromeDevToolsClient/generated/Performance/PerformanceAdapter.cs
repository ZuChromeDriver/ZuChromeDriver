namespace Zu.ChromeDevTools.Performance
{
    ...
    /// </summary>
    public partial class PerformanceAdapter
    {
        ...
        /// </summary>
        public async Task<SetTimeDomainCommandResponse> SetTimeDomain(SetTimeDomainCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<GetMetricsCommandResponse> GetMetrics(GetMetricsCommand command = null, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
