namespace Zu.ChromeDevTools.DOMSnapshot
{
    ...
    /// </summary>
    public partial class DOMSnapshotAdapter
    {
        ...
        /// flattened.
        /// </summary>
        public async Task<GetSnapshotCommandResponse> GetSnapshot(GetSnapshotCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
