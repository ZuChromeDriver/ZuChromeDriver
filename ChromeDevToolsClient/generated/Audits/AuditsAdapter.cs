namespace Zu.ChromeDevTools.Audits
{
    ...
    /// </summary>
    public partial class AuditsAdapter
    {
        ...
        /// applies to images.
        /// </summary>
        public async Task<GetEncodedResponseCommandResponse> GetEncodedResponse(GetEncodedResponseCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<CheckFormsIssuesCommandResponse> CheckFormsIssues(CheckFormsIssuesCommand command = null, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
            return await m_session.SendCommand<CheckFormsIssuesCommand, CheckFormsIssuesCommandResponse>(command ?? new CheckFormsIssuesCommand(), cancellationToken, millisecondsTimeout, throwExceptionIfResponseNotReceived);
        }
