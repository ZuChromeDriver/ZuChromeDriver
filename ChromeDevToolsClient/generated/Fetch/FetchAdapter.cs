namespace Zu.ChromeDevTools.Fetch
{
    ...
    /// </summary>
    public partial class FetchAdapter
    {
        ...
        /// </summary>
        public async Task<FailRequestCommandResponse> FailRequest(FailRequestCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<FulfillRequestCommandResponse> FulfillRequest(FulfillRequestCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<ContinueRequestCommandResponse> ContinueRequest(ContinueRequestCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<ContinueWithAuthCommandResponse> ContinueWithAuth(ContinueWithAuthCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// must be present.
        /// </summary>
        public async Task<ContinueResponseCommandResponse> ContinueResponse(ContinueResponseCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<TakeResponseBodyAsStreamCommandResponse> TakeResponseBodyAsStream(TakeResponseBodyAsStreamCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
