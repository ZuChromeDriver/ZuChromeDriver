namespace Zu.ChromeDevTools
{
    ...
    public partial class ChromeSession
    {
        ...
        private Lazy<Autofill.AutofillAdapter> m_Autofill;
        private Lazy<BackgroundService.BackgroundServiceAdapter> m_BackgroundService;
        private Lazy<BluetoothEmulation.BluetoothEmulationAdapter> m_BluetoothEmulation;
        ...
        private Lazy<CrashReportContext.CrashReportContextAdapter> m_CrashReportContext;
        ...
        private Lazy<DeviceAccess.DeviceAccessAdapter> m_DeviceAccess;
        ...
        private Lazy<Extensions.ExtensionsAdapter> m_Extensions;
        private Lazy<FedCm.FedCmAdapter> m_FedCm;
        private Lazy<Fetch.FetchAdapter> m_Fetch;
        private Lazy<FileSystem.FileSystemAdapter> m_FileSystem;
        ...
        private Lazy<PWA.PWAAdapter> m_PWA;
        ...
        private Lazy<Preload.PreloadAdapter> m_Preload;
        private Lazy<Security.SecurityAdapter> m_Security;
        private Lazy<ServiceWorker.ServiceWorkerAdapter> m_ServiceWorker;
        private Lazy<SmartCardEmulation.SmartCardEmulationAdapter> m_SmartCardEmulation;
        ...
        private Lazy<WebMCP.WebMCPAdapter> m_WebMCP;
        ...
        public ChromeSession()
        {
            ...
            m_Autofill = new Lazy<Autofill.AutofillAdapter>(() => new Autofill.AutofillAdapter(this));
            ...
            m_BluetoothEmulation = new Lazy<BluetoothEmulation.BluetoothEmulationAdapter>(() => new BluetoothEmulation.BluetoothEmulationAdapter(this));
            ...
            m_CrashReportContext = new Lazy<CrashReportContext.CrashReportContextAdapter>(() => new CrashReportContext.CrashReportContextAdapter(this));
            ...
            m_DeviceAccess = new Lazy<DeviceAccess.DeviceAccessAdapter>(() => new DeviceAccess.DeviceAccessAdapter(this));
            ...
            m_Extensions = new Lazy<Extensions.ExtensionsAdapter>(() => new Extensions.ExtensionsAdapter(this));
            m_FedCm = new Lazy<FedCm.FedCmAdapter>(() => new FedCm.FedCmAdapter(this));
            m_Fetch = new Lazy<Fetch.FetchAdapter>(() => new Fetch.FetchAdapter(this));
            m_FileSystem = new Lazy<FileSystem.FileSystemAdapter>(() => new FileSystem.FileSystemAdapter(this));
            ...
            m_PWA = new Lazy<PWA.PWAAdapter>(() => new PWA.PWAAdapter(this));
            ...
            m_Preload = new Lazy<Preload.PreloadAdapter>(() => new Preload.PreloadAdapter(this));
            ...
            m_SmartCardEmulation = new Lazy<SmartCardEmulation.SmartCardEmulationAdapter>(() => new SmartCardEmulation.SmartCardEmulationAdapter(this));
            ...
            m_WebMCP = new Lazy<WebMCP.WebMCPAdapter>(() => new WebMCP.WebMCPAdapter(this));
        ...
        /// </summary>
        public Autofill.AutofillAdapter Autofill
        {
            get { return m_Autofill.Value; }
        }
        ...
        /// </summary>
        public BluetoothEmulation.BluetoothEmulationAdapter BluetoothEmulation
        {
            get { return m_BluetoothEmulation.Value; }
        }
        ...
        /// <summary>
        /// Gets the adapter for the CrashReportContext domain.
        /// </summary>
        public CrashReportContext.CrashReportContextAdapter CrashReportContext
        {
            get { return m_CrashReportContext.Value; }
        }
        ...
        /// </summary>
        public DeviceAccess.DeviceAccessAdapter DeviceAccess
        {
            get { return m_DeviceAccess.Value; }
        }
        ...
        /// </summary>
        public Extensions.ExtensionsAdapter Extensions
        {
            get { return m_Extensions.Value; }
        }

        /// <summary>
        /// Gets the adapter for the FedCm domain.
        /// </summary>
        public FedCm.FedCmAdapter FedCm
        {
            get { return m_FedCm.Value; }
        }
        ...
        /// </summary>
        public FileSystem.FileSystemAdapter FileSystem
        {
            get { return m_FileSystem.Value; }
        }
        ...
        /// </summary>
        public PWA.PWAAdapter PWA
        {
            get { return m_PWA.Value; }
        }
        ...
        /// </summary>
        public Preload.PreloadAdapter Preload
        {
            get { return m_Preload.Value; }
        }
        ...
        /// <summary>
        /// Gets the adapter for the SmartCardEmulation domain.
        /// </summary>
        public SmartCardEmulation.SmartCardEmulationAdapter SmartCardEmulation
        {
            get { return m_SmartCardEmulation.Value; }
        }
        ...
        /// <summary>
        /// Gets the adapter for the WebMCP domain.
        /// </summary>
        public WebMCP.WebMCPAdapter WebMCP
        {
            get { return m_WebMCP.Value; }
        }
