namespace Zu.ChromeDevTools.Security
{
    ...
    /// </summary>
    public partial class SecurityAdapter
    {
        ...
        /// </summary>
        public async Task<SetIgnoreCertificateErrorsCommandResponse> SetIgnoreCertificateErrors(SetIgnoreCertificateErrorsCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<HandleCertificateErrorCommandResponse> HandleCertificateError(HandleCertificateErrorCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<SetOverrideCertificateErrorsCommandResponse> SetOverrideCertificateErrors(SetOverrideCertificateErrorsCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
