namespace Zu.ChromeDevTools.BackgroundService
{
    ...
    /// </summary>
    public partial class BackgroundServiceAdapter
    {
        ...
        /// </summary>
        public async Task<StartObservingCommandResponse> StartObserving(StartObservingCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<StopObservingCommandResponse> StopObserving(StopObservingCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<SetRecordingCommandResponse> SetRecording(SetRecordingCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<ClearEventsCommandResponse> ClearEvents(ClearEventsCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
