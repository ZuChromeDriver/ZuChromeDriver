namespace Zu.ChromeDevTools.Accessibility
{
    ...
    /// </summary>
    public partial class AccessibilityAdapter
    {
        ...
        /// </summary>
        public async Task<GetPartialAXTreeCommandResponse> GetPartialAXTree(GetPartialAXTreeCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<GetFullAXTreeCommandResponse> GetFullAXTree(GetFullAXTreeCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<GetRootAXNodeCommandResponse> GetRootAXNode(GetRootAXNodeCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// Requires `enable()` to have been called previously.
        /// </summary>
        public async Task<GetAXNodeAndAncestorsCommandResponse> GetAXNodeAndAncestors(GetAXNodeAndAncestorsCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// Requires `enable()` to have been called previously.
        /// </summary>
        public async Task<GetChildAXNodesCommandResponse> GetChildAXNodes(GetChildAXNodesCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<QueryAXTreeCommandResponse> QueryAXTree(QueryAXTreeCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
