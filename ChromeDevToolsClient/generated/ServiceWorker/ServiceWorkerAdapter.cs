namespace Zu.ChromeDevTools.ServiceWorker
{
    ...
    /// </summary>
    public partial class ServiceWorkerAdapter
    {
        ...
        /// 
        /// </summary>
        public async Task<DeliverPushMessageCommandResponse> DeliverPushMessage(DeliverPushMessageCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<DispatchSyncEventCommandResponse> DispatchSyncEvent(DispatchSyncEventCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<DispatchPeriodicSyncEventCommandResponse> DispatchPeriodicSyncEvent(DispatchPeriodicSyncEventCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<SetForceUpdateOnPageLoadCommandResponse> SetForceUpdateOnPageLoad(SetForceUpdateOnPageLoadCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<SkipWaitingCommandResponse> SkipWaiting(SkipWaitingCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<StartWorkerCommandResponse> StartWorker(StartWorkerCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<StopAllWorkersCommandResponse> StopAllWorkers(StopAllWorkersCommand command = null, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<StopWorkerCommandResponse> StopWorker(StopWorkerCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<UnregisterCommandResponse> Unregister(UnregisterCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// 
        /// </summary>
        public async Task<UpdateRegistrationCommandResponse> UpdateRegistration(UpdateRegistrationCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
