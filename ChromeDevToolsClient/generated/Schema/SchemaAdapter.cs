namespace Zu.ChromeDevTools.Schema
{
    ...
    /// </summary>
    public partial class SchemaAdapter
    {
        ...
        /// </summary>
        public async Task<GetDomainsCommandResponse> GetDomains(GetDomainsCommand command = null, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
