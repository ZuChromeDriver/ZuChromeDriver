namespace Zu.ChromeDevTools.IO
{
    ...
    /// </summary>
    public partial class IOAdapter
    {
        ...
        /// </summary>
        public async Task<CloseCommandResponse> Close(CloseCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<ReadCommandResponse> Read(ReadCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<ResolveBlobCommandResponse> ResolveBlob(ResolveBlobCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
