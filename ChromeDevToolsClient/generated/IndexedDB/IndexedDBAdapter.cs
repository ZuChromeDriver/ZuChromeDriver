namespace Zu.ChromeDevTools.IndexedDB
{
    ...
    /// </summary>
    public partial class IndexedDBAdapter
    {
        ...
        /// </summary>
        public async Task<ClearObjectStoreCommandResponse> ClearObjectStore(ClearObjectStoreCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// Deletes a database.
        /// </summary>
        public async Task<DeleteDatabaseCommandResponse> DeleteDatabase(DeleteDatabaseCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<DeleteObjectStoreEntriesCommandResponse> DeleteObjectStoreEntries(DeleteObjectStoreEntriesCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<RequestDataCommandResponse> RequestData(RequestDataCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<GetMetadataCommandResponse> GetMetadata(GetMetadataCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<RequestDatabaseCommandResponse> RequestDatabase(RequestDatabaseCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<RequestDatabaseNamesCommandResponse> RequestDatabaseNames(RequestDatabaseNamesCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
