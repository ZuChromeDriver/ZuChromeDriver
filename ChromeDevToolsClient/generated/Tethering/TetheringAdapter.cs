namespace Zu.ChromeDevTools.Tethering
{
    ...
    /// </summary>
    public partial class TetheringAdapter
    {
        ...
        /// </summary>
        public async Task<BindCommandResponse> Bind(BindCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<UnbindCommandResponse> Unbind(UnbindCommand command, CancellationToken cancellationToken = default, int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
